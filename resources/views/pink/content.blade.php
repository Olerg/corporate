                        ...
                        <div class="hentry work group portfolio-sticky portfolio-full-description">
                            <div class="work-thumbnail">
                                ...
                                <div class="work-overlay">
                                    ...
                                    <p class="work-overlay-categories"><img src="{{ asset(env('THEME')) }}/images/categories.png" alt="Categories" /> in: <a href="#">{{ $item->filter->title }}</a>
                                </div>
                            </div>
                        ...
                        <div class="overlay_a related_img">
                            <div class="overlay_wrapper">
                                ...
                                <div class="overlay">
                                    ...
                                    <a class="overlay_project" href="{{route('portfolios.show',['alias'=>$item->alias])}}">{{ $item->title }}"></a>
